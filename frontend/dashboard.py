...
st.markdown(
    """
<div class="top-shell">
    <div class="brand"><span class="brand-mark">◎</span><span>SupportAI</span></div>
    <div class="nav-wrap">
""",
    unsafe_allow_html=True,
)

tabs_list = ["Home", "Assistant", "Comparison", "Analytics", "Research", "Team", "Contact"]
...
st.markdown('<a class="nav-cta" href="?tab=Assistant" target="_self">Get Started</a>', unsafe_allow_html=True)
